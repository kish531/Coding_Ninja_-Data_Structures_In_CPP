...
C1.plus(C2) results in:  C1 = 7 + i6 and C2 = 3 + i1
...
C1.multiply(C2) results in: C1 = -6 + i13 and C2 = 1 + i2
...
Output format : Check details of 'print' function given above.
...
class ComplexNumbers {
    ...
    void multiply(ComplexNumbers const &c2){
        int multiplyReal= (real*c2.real) - (imaginary*c2.imaginary);
        int multiplyImaginary= (real*c2.imaginary) + (imaginary*c2.real);
        this->real=multiplyReal;
        this->imaginary=multiplyImaginary;
    }
    //Print
    void print(){
